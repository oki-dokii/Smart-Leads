      ...
      <div className="w-full max-w-md space-y-8 bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="-space-y-px rounded-md shadow-sm flex flex-col gap-4">
            ...
            <div>
              ...
              <select
                id="role"
                name="role"
                className="relative block w-full rounded-md border-0 py-2.5 px-3 text-gray-900 dark:text-white bg-white dark:bg-gray-800 ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                value={role}
                onChange={(e) => setRole(e.target.value as Role)}
              >
                <option value={Role.Sales}>Sales Agent</option>
          ...
          <div className="text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/login" className="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">
              Sign in here
            </Link>
          </div>
        </form>
